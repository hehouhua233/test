...
public class weiboLDAmain {
	...
	public static void main(String args[]) throws Exception {
		...
		String datadir=base + "/tweets_after.txt";
		String outputDir2 = base + "/ModelRes2/" + name + "/";
		// create output folder
		FileUtil.mkdir(new File(base + "/ModelRes2/"));
		FileUtil.mkdir(new File(outputDir2));
		...
		String outputWordsInTopics = outputDir2 + "WordsInTopics.txt";
		String outputBackgroundWordsDistribution = outputDir2
				+ "BackgroundWordsDistribution.txt";
		String outputTextWithLabel = outputDir2 + "/TextWithLabel/";
		...
		user tweetuser = new user(filelist, "result.txt",wordMap, uniWordMap);
		users.add(tweetuser);
		...
		FileUtil.writeLines(outputDir2 + "wordMap.txt", wordMap);
		FileUtil.writeLines(outputDir2 + "uniWordMap.txt", uniWordMap);
		...
		model.outputTopicDistributionOnUsers(outputDir2, users);
		System.out.println("read uniwordmap");
		FileUtil.readLines(outputDir2 + "uniWordMap.txt", uniWordMap);
